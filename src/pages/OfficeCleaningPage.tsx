...
export default function OfficeCleaningPage() {
  ...
  const services: ServiceItem[] = [
    ...
    { id: "4", name: "Carpet cleaning", link: "/services/carpet-cleaning" },
    {
      id: "5",
      name: "Upholstery cleaning",
      link: "/services/upholstery-cleaning",
    },
    { id: "6", name: "Same Day cleaning", link: "/services/same-day-cleaning" },
    {
      id: "7",
      name: "Kitchen Deep Cleaning",
      link: "/services/kitchen-deep-cleaning",
    },
    { id: "8", name: "Rug Cleaning", link: "/services/rug-cleaning" },
    { id: "9", name: "Move in cleaning", link: "/services/move-in-cleaning" },
    {
      id: "10",
    ...
    { id: "12", name: "Spring cleaning", link: "/services/spring-cleaning" },
  ];
  ...
  const faqData: FAQItemData[] = [
    ...
    {
      id: "house-cost",
      question: "How much do office cleaners charge per hour in the UK?",
      answer:
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden w-full">
      ...
      <div className="max-w-7xl mx-auto mt-[2.5rem] md:mt-[4rem] lg:mt-[5rem] bg-white rounded-lg shadow-lg overflow-hidden md:flex">
        ...
        <div className="md:w-1/2 overflow-hidden">
          <img
            src="https://www.emop.co.uk/static/redesign/images/services/office/3.jpg"
            alt="Cleaning services in living room"
            className="w-full h-full object-cover object-center"
            onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => {
              const target = e.target as HTMLImageElement;
      ...
      <div className="max-w-7xl mx-auto mt-[2.5rem] md:mt-[4rem] lg:mt-[5rem] bg-white rounded-lg shadow-lg overflow-hidden md:flex">
        ...
        <div className="md:w-1/2 overflow-hidden">
          <img
            src="https://www.emop.co.uk/static/redesign/images/services/office/4.jpg"
            alt="Cleaning services in living room"
            className="w-full h-full object-cover object-center"
            onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => {
              const target = e.target as HTMLImageElement;
