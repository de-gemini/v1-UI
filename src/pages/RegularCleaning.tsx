...
export default function RegularCleaning() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden w-full">
      <Banner title="Regular Cleaners in England" />
      ...
      <div className="bg-white p-8 md:p-12 lg:p-16 rounded-lg w-full max-w-4xl mx-auto my-12">
        ...
        <div className="flex flex-col sm:flex-row w-full bg-white rounded-lg overflow-hidden shadow-md border border-blue-800 focus-within:border-blue-800 transition-colors duration-200">
      ...
      De-Gemini Regular Cleaning in England
      </h1>
