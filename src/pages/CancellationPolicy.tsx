      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-4xl mx-auto bg-white p-6 md:p-10 rounded-xl shadow-sm">
          ...
          <main className="mt-6 text-gray-600 leading-relaxed space-y-4">
            ...
            <p>
              If a client cancels a job less than 12 hours before the start time or at the last minute, our De-gemini lose their income and it messes with their schedule. Clients' cancellation fees cover De-gemini' time and the De-gemini platform's costs.
            </p>
          </main>
