...
After you have paid the deposit, we will provide you with access to the mobile App where you will pick up all your jobs and we will schedule your first test cleaning job with a client.`,
        },
        {
          ...
          answer: `The process usually takes 1-4 days from the date of the interview. If you would like an update on your application please contact the eMop office via email. emopper@emop.world.`,
        },
        {
          id: "prospective-4",
          question: "How much can I earn?",
          answer:
            "Earnings depend on the number of jobs you take, your efficiency, and your rating. eMop offers competitive hourly rates, and you keep 100% of your tips.",
        },
      ],
    },
  ];
