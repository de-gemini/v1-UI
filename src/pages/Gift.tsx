...
>
  ...
  <div className="w-full px-6 sm:px-16 flex flex-col items-center mt-10 mb-12">
    <h1 className="text-brand-primary nunito-sans-heading text-3xl sm:text-5xl font-extrabold mb-2 text-center">Gift Vouchers</h1>
    <p className="text-lg sm:text-xl text-[rgb(80,96,107)] font-medium mb-2 text-center">Bespoke cleaning services for your home</p>
    <h2 className='text-brand-primary text-2xl sm:text-4xl nunito-sans-title font-bold mt-2 mb-4 text-center'>Make someone smile today</h2>
  </div>

  <div className="w-full px-6 sm:px-16 flex flex-col items-center">
    <div className="max-w-4xl w-full bg-white/80 rounded-2xl shadow-lg mb-12 p-6 sm:p-10 lg:p-12">
      <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-brand-primary mb-8 text-center">Choose your voucher amount:</h1>
        ...
        {voucherAmounts.map(amount => (
          <button
            ...
            onClick={() => {
              ...
              console.log('Voucher amount selected:', amount);
            }}
            className={`p-4 sm:p-5 rounded-lg border-2 font-bold text-lg sm:text-2xl transition-all duration-300 ease-in-out
      ...
      <form onSubmit={handlePurchase} className="space-y-10">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <input
              ...
              className="p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-400 text-base sm:text-lg"
            ...
            <input
              ...
              onChange={handleSenderChange}
              className="p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-400 text-base sm:text-lg sm:col-span-2"
        ...
        {/* Payment Details */}
        <div className="border-t border-gray-200 pt-8 flex flex-col lg:flex-row lg:space-x-12">
          {/* Left Column: Payment Inputs */}
          <div className="lg:w-1/2 mb-8 lg:mb-0">
            {renderSectionHeader('Payment details')}
            <div className="text-right text-xs text-gray-500 mb-2">Powered by <span className="font-semibold text-gray-700">stripe</span></div>
            <div className="space-y-4">
              <input
                ...
                maxLength={19}
                className="p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-400 w-full font-mono text-base sm:text-lg"
              ...
              <input
                ...
                onChange={handlePaymentChange}
                className="p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-400 w-full text-base sm:text-lg"
          ...
          <div className="lg:w-1/2 flex flex-col justify-between items-center lg:items-end mt-8 lg:mt-0">
            ...
            <div className="w-full max-w-sm flex flex-col items-center">
              ...
              <button
                type="submit"
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-bold py-3 px-8 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed text-base sm:text-lg"
