      ...
      <nav className="max-w-7xl mx-auto flex items-center justify-between py-4 px-4 md:px-6">
        ...
        <ul className="hidden md:flex items-center space-x-6 lg:space-x-8">
          ...
          >
            ...
            <div
              className={`absolute left-1/2 -translate-x-1/2 mt-4 bg-white shadow-lg rounded-lg p-4 w-[calc(100vw-2rem)] max-w-4xl grid grid-cols-2 gap-x-6 gap-y-2 transition-all duration-300 ease-in-out
